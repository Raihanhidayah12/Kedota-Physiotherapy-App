...
class OtpRateLimitScreen extends StatefulWidget {
  final String phoneNumber;

  const OtpRateLimitScreen({super.key, required this.phoneNumber});

  @override
  State<OtpRateLimitScreen> createState() => _OtpRateLimitScreenState();
}

class _OtpRateLimitScreenState extends State<OtpRateLimitScreen> {
