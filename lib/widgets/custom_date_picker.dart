          ...
          children: [
                      ...
                      return PopupMenuItem<int>(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isSelected ? const Color(0xFF00A79D) : const Color(0xFF1E293B),
                          ),
                        ),
                      );
                    });
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelectable = currentDate.isAfter(widget.firstDate.subtract(const Duration(days: 1))) && 
                                     currentDate.isBefore(widget.lastDate.add(const Duration(days: 1)));

                return GestureDetector(
                  onTap: isSelectable ? () => _onDateSelected(currentDate) : null,
                  child: Container(
                    decoration: BoxDecoration(
                      color: isSelected ? const Color(0xFFD8E4EB) : Colors.transparent, // Light blue from Figma
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: !isSelectable 
                              ? const Color(0xFFCBD5E1) // Greyed out if unselectable
                              : const Color(0xFF1E293B), // Dark text otherwise
                        ),
                      ),
                    ),
                  ),
